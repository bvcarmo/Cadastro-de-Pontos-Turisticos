...
public class TelaPrincipal {
    ...
    private final TelaCadastroPonto telaCadastroPonto;
    ...
    private JMenuItem menuCadastrarPT;
    private JMenuItem menuAlterarPT;
    private JMenuItem menuPesquisarPT;
    private JMenuItem menuListarPT;
    ...
    public TelaPrincipal() {
        ...
        telaCadastroPonto = new TelaCadastroPonto(this);
    ...
    private void configurarEventosTela() {
        ...
        menuCadastrarPT.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                telaCadastroPonto.inicializar();
            }
            });
        
        menuPesquisarPT.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String opcoes [] = {"Pesquisar pelo nome", "Pesquisar pela chave", "Pesquisar "};
                JOptionPane.showInputDialog(janela, "Você quer pesquisar como: ","Pesquisar Ponto Turístico ",JOptionPane.QUESTION_MESSAGE, null, opcoes," Pesquisar pelo nome");
            }
        });
    ...
    private void construirMenuInicio() {
        ...
        menuCadastrarPT = new JMenuItem(I18N.obterMenuCadastrarPT());
        menuAlterarPT = new JMenuItem(I18N.obterMenuAlterarPT());
        menuPesquisarPT = new JMenuItem(I18N.obterMenuPesquisarPT());
        menuListarPT = new JMenuItem(I18N.obterMenuListarPT());
        if (!sessaoUsuario.estahLogado()) {
            ...
            menuInicio.add(menuCadastrarPT);
            menuInicio.add(menuAlterarPT);
            menuInicio.add(menuPesquisarPT);
            menuInicio.add(menuListarPT);
