...
public class I18N {
    ...
    public static String obterMenuCadastrarPT(){
        return rb.getString("menu.inicio.cadastrarpt");
    }
    
    public static String obterMenuPesquisarPT(){
        return rb.getString("menu.inicio.pesquisarpt");
    }
    
    public static String obterMenuListarPT(){
        return rb.getString("menu.inicio.listarpt");
    }
    public static String obterMenuAlterarPT(){
        return rb.getString("menu.inicio.alterarpt");
    }
    /**
    ...
    public static String obterRotuloPontoturNome() {
        return rb.getString("rotulo.pontotur.nome");
    }

    
    public static String obterRotuloPontoturDesc() {
        return rb.getString("rotulo.pontotur.desc");
    }

    public static String obterRotuloPontoturTags() {
        return rb.getString("rotulo.pontotur.tags");
    }
    ...
    public static String obterTituloTelaCadastroPonto() {
        return rb.getString("tela.cadastroponto.titulo");
    }
    /**
